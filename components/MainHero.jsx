    ...
    <div className="flex py-5" id="home">
      <div className="flex sm:flex-row-reverse flex-col px-5 w-full max-w-3xl mx-auto">
        <div className="inline-block">
          <div className="h-[200px] w-[200px] overflow-hidden rounded-full mx-auto relative">
            <Image priority src="/images/James_Marshall1.jpg" alt="James Marshall" layout="fill" objectFit="cover" />
          </div>
        </div>
